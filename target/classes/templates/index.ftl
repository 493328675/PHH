...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-main">
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" pc>
                    <a href="javascript:">
                        <img src="http://www.kaoyan1v1.com/UploadFiles/new/2018/6/201806071735377957.jpg" class="layui-circle" width="35" height="35">
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            <a class="img" title="我的头像" ><img src="http://www.kaoyan1v1.com/UploadFiles/new/2018/6/201806071735377957.jpg"></a>
    ...
    <div class="layui-footer footer">
        <p>Design By PHH <a href="http://www.miibeian.gov.cn" target="_blank"><#--苏ICP备17063650号 --></a></p>
    </div>
</div>
<script>
    var baseUrl = "${base}";
